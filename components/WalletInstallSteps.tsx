    ...
    return (
        <div className="flex items-center justify-center gap-6 py-8">
            <div className={`rounded-lg p-4 border-2 ${isPraxInstalled
                ? 'bg-green-900/10 border-green-600/50 text-green-500'
                : 'bg-gray-900/10 border-blue-500'
                }`}>
                {isPraxInstalled ? (
            ...
            <div className={`rounded-lg p-4 border-2 ${!isPraxInstalled ? 'bg-gray-900/20 border-gray-700 text-gray-500' :
                connected ? 'bg-green-900/10 border-green-600/50 text-green-500' : 'bg-gray-900/10 border-blue-500'
                }`}>
                {connected ? (
                    <div className="font-medium">
                        Wallet Connected
