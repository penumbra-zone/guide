...
This quick start guide will help you get started with Penumbra using a web-based wallet, and walk you through each basic feature. For more detailed walkthroughs of each feature, see the [web](./using-penumbra/web.mdx) section.
...
Use the [Send](https://app.penumbra.zone/#/send) page to send tokens privately within Penumbra.
