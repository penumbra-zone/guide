...
See the [IBC user docs](../using-penumbra/pcli/transaction.md#ibc-withdrawals) for how to use
...
Use the [IBC user docs](../using-penumbra/pcli/transaction.md#ibc-withdrawals) to make a test transaction,
...
See the [IBC pcli docs](../using-penumbra/pcli/transaction.md#ibc-withdrawals) for more details.
