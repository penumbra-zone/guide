...
By default, Prax Wallet will select a frontend app to use with the wallet. This is a web interface that you will use together with your Prax Wallet to interact with the blockchain.
