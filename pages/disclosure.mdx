...
For further technical details about transaction plans, see the details of [Transaction Signing](https://protocol.penumbra.zone/main/transactions/signing.html) in Penumbra's protocol documentation. For more details about how Penumbra built selective disclosure into the protocol, see [this blog post](https://penumbra.zone/blog/how-to-see-in-the-dark).