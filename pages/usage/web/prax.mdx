...
Prax Wallet is a browser extension that only supports Chromium-based web browsers.

Visit the [Prax Wallet] homepage, and click **Download Prax Wallet** to install it.

## Generating a wallet

When you first open the extension, you'll have the option to import an existing wallet. If you don't already have one, choose **Create a new wallet**.
...
You can view the latest version of the extension by visiting [Prax Wallet] page and clicking through to the Chrome Web Store. To force a check for updates:
