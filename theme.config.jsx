...
export default {
  ...
  head: function useHead() {
    ...
    const title = pageTitle ? pageTitle + ' – Penumbra Guide' : 'Penumbra Guide';
    const description = 'Penumbra is a shielded, cross-chain network allowing anyone to securely transact, stake, swap, or marketmake without broadcasting their personal information to the world.';
